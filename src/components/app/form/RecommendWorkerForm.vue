...
<script>
import { sendWorkerRecommendationForm } from '../../../vuex/actions/forms'
...
export default {
  ...
  vuex: {
    ...
    getters: {
      auth,
      isLocked: ({ forms }) => forms.recommendWorker.isLocked
    }
  },
  methods: {
    send () {
      this.$progress.start()
      this.sendWorkerRecommendationForm(this.form, this.fileData)
